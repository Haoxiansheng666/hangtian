            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <img style="height: 150px;width: 150px;" src="<?php echo isset($info['link'])?$info['link']:''; ?>" id="link-view" name="link">
                  </div>
                </div>
                <?php endif; ?>
