            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写姓名"
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="class" type="text" class="col-xs-10 col-sm-5" placeholder="请填写部门"
				...
				<div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-10 col-lg-5" style="padding-right: 0px;">
                                        <script style="width: 600px;height: 200px" id="content" name="content" text="text/plain"><?php echo $info['content']; ?></script>
                                    </div>
                                </div>
                            </div>
                <div class="form-group">
...
<script type="text/javascript">
$('a[href="/Admin/Teams/index.html"]').parents().filter('li').addClass('open active');
//提交表单
