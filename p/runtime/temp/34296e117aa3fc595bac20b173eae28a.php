            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <textarea name="describe" class="col-xs-10 col-sm-5" cols="30" rows="10" maxlength="64" style="height: 100px;" placeholder="请填写描述"><?php echo $info['describe']; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
