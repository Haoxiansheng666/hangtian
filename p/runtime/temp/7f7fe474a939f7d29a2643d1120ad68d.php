<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"F:\phpStudy\PHPTutorial\WWW\pc\public/../application/admin\view\problems\problem.html";i:1587719870;s:69:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\top.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\header.html";i:1541637510;s:73:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\sidebar.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\bottom.html";i:1541637510;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                            ...
                            <div class="col-xs-12" style="margin-bottom:10px;">
                                <form action="<?php echo url('index'); ?>" method="get" class="form-inline" role="form">
                                    <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;"
                                       href="<?php echo url('problem_add'); ?>">添加信息</a>
                                </form>
                            </div>
                            <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success"
                                               href="<?php echo url('problem_edits',array('id'=>$vo['id'])); ?>">修改</a>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $('.state').change(function () {
            ...
            $.post("<?php echo url('problem_edits'); ?>", {id: id, status: state}).success(function (data) {
