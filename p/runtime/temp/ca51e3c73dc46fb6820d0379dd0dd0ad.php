<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"D:\PHPTutorial\WWW\anji\public/../application/admin\view\pictures\video.html";i:1570611433;s:62:"D:\PHPTutorial\WWW\anji\application\admin\view\common\top.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\header.html";i:1541637509;s:66:"D:\PHPTutorial\WWW\anji\application\admin\view\common\sidebar.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\bottom.html";i:1541637509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo url('index'); ?>">照片管理</a></li>
                            ...
                            <div class="col-xs-12" style="margin-bottom:10px;">
                                <form action="<?php echo url('index'); ?>" method="get" class="form-inline" role="form">
                                    <div class="form-group">
                                        <label>关键词</label>
                                        <input name="keywords" type="text" class="form-control" placeholder="标题">
                                    </div>
                                    <button type="submit" class="btn btn-sm btn-primary">查询</button>
                                    <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;"
                                       href="<?php echo url('add_video'); ?>">添加信息</a>
                                    <button type="reset" class="btn btn-sm btn-danger hidden-xs"
                                            style="float:right;margin-right:10px;">清空查询条件
                                    </button>
                                </form>
                            </div>
                            <div class="col-xs-12">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <video src="<?php echo $vo['link']; ?>" style="height:100px;width: 100px"
                                                   controls="controls" autoplay="autoplay">
                                            </video>
                                        </td>
                                        <td>
                                            <a class="btn btn-sm btn-success"
                                               href="<?php echo url('edits_video',array('id'=>$vo['id'])); ?>">修改</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="state form-control" data-id="<?php echo $vv['id']; ?>">
                                                ...
                                                <option value="<?php echo $so['value']; ?>" {eq name="vv['is_show']"
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success"
                                               href="<?php echo url('edits_video',array('id'=>$vv['id'])); ?>">修改</a>
                                            <a class="btn btn-sm btn-danger" href="javascript:void(0);"
...
<script type="text/javascript">
    $('a[href="/Admin/Pictures/video.html"]').parents().filter('li').addClass('open active');
</script>
<script type="text/javascript">
    jQuery(function ($) {
        //清除查询条件
