<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"/data/wwwroot/anjiWebsite/public/../application/admin/view/messages/add.html";i:1601172236;s:64:"/data/wwwroot/anjiWebsite/application/admin/view/common/top.html";i:1541637510;s:67:"/data/wwwroot/anjiWebsite/application/admin/view/common/header.html";i:1541637510;s:68:"/data/wwwroot/anjiWebsite/application/admin/view/common/sidebar.html";i:1541637510;s:67:"/data/wwwroot/anjiWebsite/application/admin/view/common/bottom.html";i:1541637510;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="name" disabled type="text" class="col-xs-10 col-sm-5" placeholder="请填写目标" value="<?php echo $info['name']; ?>" />
                  </div>
                </div>
                <!--<div class="form-group">-->
                  <!--<label class="col-sm-3 control-label no-padding-right"> 标题 </label>-->
                  <!--<div class="col-sm-9">-->
                    <!--<input name="title" type="text" class="col-xs-10 col-sm-5" placeholder="请填写标题" value="<?php echo $info['title']; ?>" />-->
                  <!--</div>-->
                <!--</div>-->
                <!--<div class="form-group">-->
                  <!--<label class="col-sm-3 control-label no-padding-right"> 简介 </label>-->
                  <!--<div class="col-sm-9">-->
                    <!--<textarea name="jj" cols="5" type="textera" class="col-xs-10 col-sm-5" placeholder="请填写简介" value=""><?php echo $info['jj']; ?></textarea>-->
                  <!--</div>-->
                <!--</div>-->
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right">图片 </label>
                  <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                    <input name="link" type="text" class="form-control" readonly placeholder="这里图片上传地址"
                           value="<?php echo $info['link']; ?>">
                    <!--<img name="link" width="150px" height="150px" hidden="" id="link-view"/>-->
                  </div>
                  <div class="col-sm-2 col-lg-2" style="padding-left: 0px;">
                    <a href="javascript:void(0);" class="btn btn-sm btn-success" id="test1"
                       data-type="headimg">图片上传</a>
                  </div>
                </div>
                <?php if($info['link']): ?>
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <img style="height: 150px;width: 150px;" src="<?php echo isset($info['link'])?$info['link']:''; ?>" name="link" id="link-view">
                  </div>
                </div>
                <?php else: ?>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right">  </label>
                  <div class="col-sm-9">
                    <img style="height: 150px;width: 150px;" src="/web/img/anji.png" name="link" id="link-view">
                  </div>
                </div>
                <?php endif; ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <!-- <input name="content" type="text" class="col-xs-10 col-sm-5" placeholder="请填写内容" value="<?php echo $info['content']; ?>" /> -->
                    <div class="col-sm-10 col-lg-5" style="padding-right: 0px;">
     <!--               <?php if($info['id'] == 1): ?>-->
     <!--               <textarea name="content" cols="30" rows="10" maxlength="64" style="height: 300px;width:500px" placeholder="请填写描述">1<?php echo $info['content']; ?></textarea>-->
     <!--               <?php elseif($info['id'] == 2): ?>-->
     <!--               <textarea name="content" cols="30" rows="10" maxlength="64" style="height: 300px;width:500px" placeholder="请填写描述">2<?php echo $info['content']; ?></textarea>-->
     <!--               <?php elseif($info['id'] == 3): ?>-->
     <!--               <textarea name="content" cols="30" rows="10" maxlength="64" style="height: 300px;width:500px" placeholder="请填写描述">3<?php echo $info['content']; ?></textarea>-->
     <!--               <?php else: ?>-->
     <!--               <textarea name="content" cols="30" rows="10" maxlength="64" style="height: 300px;width:500px" placeholder="请填写描述">4<?php echo $info['content']; ?></textarea>-->
					<!--<?php endif; ?>-->
                      <script style="width: 1000px;height: 800px" id="content" name="content" text="text/plain"><?php echo $info['content']; ?></script>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
$('a[href="/Admin/Messages/index.html"]').parents().filter('li').addClass('open active');
//提交表单
