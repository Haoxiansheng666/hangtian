<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"/data/wwwroot/anjiWebsite/public/../application/admin/view/products/add.html";i:1601017181;s:64:"/data/wwwroot/anjiWebsite/application/admin/view/common/top.html";i:1541637509;s:67:"/data/wwwroot/anjiWebsite/application/admin/view/common/header.html";i:1541637509;s:68:"/data/wwwroot/anjiWebsite/application/admin/view/common/sidebar.html";i:1541637509;s:67:"/data/wwwroot/anjiWebsite/application/admin/view/common/bottom.html";i:1541637509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal form-post" role="form" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写名称"
                                           value="<?php echo $info['name']; ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">图片(实) </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">图片(虚) </label>
                                <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                                    <input name="e_link" type="text" class="form-control" readonly placeholder="这里图片上传地址"
                                           value="<?php echo $info['e_link']; ?>">
                                    <!--<img name="e_link" width="150px" height="150px" hidden="" id="e_link-view"/>-->
                                </div>
                                <div class="col-sm-2 col-lg-2" style="padding-left: 0px;">
                                    <a href="javascript:void(0);" class="btn btn-sm btn-success" id="test2"
                                       data-type="headimg">图片上传</a>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">  </label>
                                <div class="col-sm-9">
                                    <img style="height: 150px;width: 150px;" src="<?php echo isset($info['e_link'])?$info['e_link']:''; ?>" name="e_link" id="e_link-view">
                                </div>
                            </div>
                            <?php else: ?>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">  </label>
                                <div class="col-sm-9">
                                    <img style="height: 150px;width: 150px;" src="/web/img/anji.png" name="e_link" id="e_link-view">
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <button class="btn btn-info" type="submit" id="btn"><i
                                            class="ace-icon fa fa-check bigger-110"></i> 保存
                                    </button>
                                </div>
                            </div>
                        </form>
        ...
        var uploadInst = upload.render({
            ...
            , done: function (res) {
                ...
                if (res.status == 0) {
                    ...
                    $('#e_link-view').show();
                    //返回路径
                    $("input[name=e_link]").val(res.msg);
                    //给IMG返回路径
                    $("img[name=e_link]").attr("src", res.msg)
                }
            }
        });
    });
...
<script type="text/javascript">
    $('a[href="/Admin/Products/index.html"]').parents().filter('li').addClass('open active');
    //提交表单
