            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写名称" value="<?php echo $info['name']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 排序 </label>
                  <div class="col-sm-9">
                    <input name="sort" type="text" class="col-xs-10 col-sm-5" placeholder="请填写名称" value="<?php echo $info['sort']; ?>" />
                  </div>
                </div>
...
<script type="text/javascript">
$('a[href="/Admin/Partners/index.html"]').parents().filter('li').addClass('open active');
//提交表单
