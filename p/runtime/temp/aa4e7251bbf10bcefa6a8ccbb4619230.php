<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"F:\phpStudy\PHPTutorial\WWW\pc\public/../application/admin\view\index\profile.html";i:1545882520;s:69:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\top.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\header.html";i:1541637510;s:73:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\sidebar.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\bottom.html";i:1541637510;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<style>dt,dd{line-height:24px;}</style>
</head>
<body class="no-skin">
            ...
            <div class="main-content-inner">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1> <?php echo $pagename; ?> <small> <i class="ace-icon fa fa-angle-double-right"></i> 显示个人的账号信息 </small> </h1>
                    </div>
                    <div class="row">
                        <div class="col-xs-12"> 
                            <!-- PAGE CONTENT BEGINS -->
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <dl class="">
                                            ...
                                            <dt>所属用户组</dt>
                                            <dd><?php echo $info['groupName']; ?></dd>
                                            <dt>最后一次登录IP</dt>
                                            <dd><?php echo $info['last_login_ip']; ?></dd>
                                            <dt>最后一次登录时间</dt>
                                            <dd><?php echo $info['last_login_time']; ?></dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
...
<script src="/static/ace/js/ace/ace.sidebar.js"></script> 
    <script type="text/javascript">
        $('a[href="/Admin/Index/profile.html"]').parents().filter('li').addClass('open active');
    </script>
</body>
</html>