        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo url('index'); ?>">产品介绍</a></li>
                            ...
                            <div class="col-xs-12" style="margin-bottom:10px;">
                                <form action="<?php echo url('index'); ?>" method="get" class="form-inline" role="form">
                                    <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;"
                                       href="<?php echo url('ldea_add'); ?>">添加信息</a>
                                </form>
                            </div>
                            <div class="col-xs-12">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><img style="width: 50px;height: 50px" src="<?php echo $vo['link']; ?>"></td>
                                        <td><?php echo $vo['title']; ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-success"
                                               href="<?php echo url('ldea_edits',array('id'=>$vo['id'])); ?>">修改</a>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $('.state').change(function () {
            ...
            $.post("<?php echo url('ldea_edits'); ?>", {id: id, status: state}).success(function (data) {
