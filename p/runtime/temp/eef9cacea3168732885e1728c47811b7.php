<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\PHPTutorial\WWW\anji\public/../application/admin\view\overviews\adva_add.html";i:1587871023;s:62:"D:\PHPTutorial\WWW\anji\application\admin\view\common\top.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\header.html";i:1541637509;s:66:"D:\PHPTutorial\WWW\anji\application\admin\view\common\sidebar.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\bottom.html";i:1541637509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<script type="text/javascript">
    $('a[href="/Admin/Overviews/adva.html"]').parents().filter('li').addClass('open active');
    //提交表单
    $(".form-post").find('button:submit').click(function () {
        $.post("<?php echo url('adva_add'); ?>", $(".form-post").serialize()).success(function (data) {
