...
$('a[href="/Admin/Overviews/picture.html"]').parents().filter('li').addClass('open active');
//提交表单
$(".form-post").find('button:submit').click(function() {
  $.post("<?php echo url('picture_add'); ?>", $(".form-post").serialize()).success(function(data) {
    ...
    if (data.status === 0) {
      ...
      setTimeout(function() {
        location.href = '/Admin/Overviews/picture';
      },
      1000);
    }
  });
