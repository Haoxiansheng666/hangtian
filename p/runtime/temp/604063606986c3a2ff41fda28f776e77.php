<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:70:"D:\PHPTutorial\WWW\anji\public/../application/admin\view\tops\add.html";i:1587634293;s:62:"D:\PHPTutorial\WWW\anji\application\admin\view\common\top.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\header.html";i:1541637509;s:66:"D:\PHPTutorial\WWW\anji\application\admin\view\common\sidebar.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\bottom.html";i:1541637509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="title" type="text" class="col-xs-10 col-sm-5" placeholder="请填写名称" value="<?php echo $info['title']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 链接地址 </label>
                  <div class="col-sm-9">
                    <input name="url" type="text" class="col-xs-10 col-sm-5" placeholder="请填写链接地址" value="<?php echo $info['url']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 排序 </label>
                  <div class="col-sm-9">
                    <input name="sort" type="text" class="col-xs-10 col-sm-5" placeholder="请填写链接地址" value="<?php echo $info['sort']; ?>" />
                  </div>
                </div>
...
$('a[href="/Admin/Tops/index.html"]').parents().filter('li').addClass('open active');
//提交表单
