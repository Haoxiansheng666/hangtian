          ...
          <div class="col-xs-12">
            <form class="form-horizontal form-post" role="form" method="post">
              ...
              <!--<div class="form-group">-->
                ...
                <!--<div class="col-sm-9">-->
                  <!--&lt;!&ndash; <input name="content" type="text" class="col-xs-10 col-sm-5" placeholder="请填写内容" value="<?php echo $info['content']; ?>" /> &ndash;&gt;-->
...
<script type="text/javascript">
  $('a[href="/Admin/Problems/problem.html"]').parents().filter('li').addClass('open active');
  //提交表单
  $(".form-post").find('button:submit').click(function() {
    $.post("<?php echo url('problem_add'); ?>", $(".form-post").serialize()).success(function(data) {
