            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写时间" value="<?php echo $info['name']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 事件 </label>
                  <div class="col-sm-9">
                    <textarea name="title" type="text" style="height: 80px" class="col-xs-10 col-sm-5" placeholder="请填写事件"><?php echo $info['title']; ?></textarea>
                  </div>
                </div>
...
$('a[href="/Admin/Courses/index.html"]').parents().filter('li').addClass('open active');
//提交表单
