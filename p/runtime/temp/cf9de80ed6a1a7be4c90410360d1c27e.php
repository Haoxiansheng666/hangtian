<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"F:\phpStudy\PHPTutorial\WWW\pc\public/../application/admin\view\notices\index.html";i:1597999798;s:69:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\top.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\header.html";i:1541637510;s:73:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\sidebar.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\bottom.html";i:1541637510;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                            ...
                            <div class="col-xs-12">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <!--<td><img style="height: 50px;width: 50px" src="<?php echo $vo['link']; ?>"></td>-->
                                        ...
                                        <!--<td>-->
                                            <!--<select class="state form-control" data-id="<?php echo $vo['id']; ?>">-->
                                                ...
                                                <!--<option value="<?php echo $so['value']; ?>" {eq name="vo['is_show']"-->
                                                        <!--value="$so['value']" }selected{-->
                                                <!--/eq} ><?php echo $so['key']; ?></option>-->
                                                <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
                                            <!--</select>-->
                                        <!--</td>-->
                                        <td><?php echo date("Y-m-d H:i:s",$vo['time']); ?></td>
                                        <!--<td>-->
                                        <!--<input class="col-xs-10 sort" value="<?php echo $vo['sort']; ?>" data-id="<?php echo $vo['id']; ?>">-->
                                        <!--</td>-->
                                        <td>
