        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo url('index'); ?>">产品中心</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success"
                                               href="<?php echo url('picture_edits',array('id'=>$vo['id'])); ?>">修改</a>
