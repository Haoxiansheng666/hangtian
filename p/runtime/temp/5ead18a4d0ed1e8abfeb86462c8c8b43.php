<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"D:\PHPTutorial\WWW\anji\public/../application/admin\view\notices\add.html";i:1600933804;s:62:"D:\PHPTutorial\WWW\anji\application\admin\view\common\top.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\header.html";i:1541637509;s:66:"D:\PHPTutorial\WWW\anji\application\admin\view\common\sidebar.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\bottom.html";i:1541637509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 资讯类型 </label>
                  <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                    <select name="tid" class="state form-control" data-id="<?php echo $vo['id']; ?>">
                      ...
                      <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $info['tid']): ?>selected<?php endif; ?> ><?php echo $vo['name']; ?></option>
                      <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                  </div>
                </div>
                ...
                <!--<div class="form-group">-->
                  ...
                  <!--<div class="col-sm-9">-->
                    <!--<img style="height: 150px;width: 150px;" src="<?php echo isset($info['link'])?$info['link']:''; ?>">-->
                  <!--</div>-->
                <!--</div>-->
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="source" type="text" class="col-xs-10 col-sm-5" placeholder="请填写关键字" value="<?php echo $info['source']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 文章描述 </label>
                  <div class="col-sm-9">
                      <textarea name="describe" class="col-xs-10 col-sm-5"  style="height: 100px" placeholder="请填写描述"><?php echo $info['describe']; ?></textarea>
                    <!--<input name="describe" type="text" class="col-xs-10 col-sm-5" placeholder="请填写描述" value="<?php echo $info['describe']; ?>" />-->
                  </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
$('a[href="/Admin/Notices/index.html"]').parents().filter('li').addClass('open active');
//提交表单
