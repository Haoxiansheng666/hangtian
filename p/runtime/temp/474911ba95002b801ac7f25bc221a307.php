                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                                                <input name="<?php echo $vo['key']; ?>" type="text" class="form-control" placeholder="此处填写<?php echo $vo['info']; ?>" value="<?php echo $vo['value']; ?>" >
                                            </div>
...
<script src="/static/ace/js/ace/ace.sidebar.js"></script> 
    ...
    <script type="text/javascript">
                          $('a[href="/Admin/Config/index.html"]').parents().filter('li').addClass('open active');
