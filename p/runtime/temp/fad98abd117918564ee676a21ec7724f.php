<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\11\anji\public/../application/index\view\index\notice.html";i:1588746494;s:52:"D:\11\anji\application\index\view\public\header.html";i:1588069630;s:49:"D:\11\anji\application\index\view\public\top.html";i:1588122557;s:52:"D:\11\anji\application\index\view\public\footer.html";i:1588747813;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>媒体中心</title>
...
<!--                <li class="choice" onclick="type1('<?php echo $v['id']; ?>')"><?php echo $v['name']; ?></li>-->
                <li class="choice"> <a style="color:inherit" href="<?php echo url('Index/index/notice'); ?>?type=<?php echo $v['id']; ?>"><?php echo $v['name']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <hr>
<!--            <div id="forloop">-->
...
<footer class="footer">
    ...
    <div class="last danColor" >
		<span>Copyright © 2008-2020 vip.com，All Rights Reserved  使用本网站即表示接受 唯品会用户协议。版权所有 广州唯品会电子商务有限公司</span> <br>
		<a href=""></a>
		<a href=""></a>
		<a href=""></a>
		<a href=""></a>
