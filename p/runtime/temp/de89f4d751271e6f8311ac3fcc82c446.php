<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"D:\PHPTutorial\WWW\anji\public/../application/admin\view\footers\add.html";i:1588754313;s:62:"D:\PHPTutorial\WWW\anji\application\admin\view\common\top.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\header.html";i:1541637509;s:66:"D:\PHPTutorial\WWW\anji\application\admin\view\common\sidebar.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\bottom.html";i:1541637509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
              ...
              <form class="form-horizontal form-post" role="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                    <select name="type" class="state form-control" data-id="<?php echo $vo['id']; ?>">
                      <option value="">请选择类型</option>
                      <option value="1" <?php if(1 == $info['type']): ?>selected<?php endif; ?> >备案凭证</option>
                      <option value="2" <?php if(2 == $info['type']): ?>selected<?php endif; ?> >经营许可</option>
                    </select>
                  </div>
                </div>
                <!--<div class="form-group">-->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写标题" value="<?php echo $info['name']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 地址 </label>
                  <div class="col-sm-9">
                    <input name="url" type="text" class="col-xs-10 col-sm-5" placeholder="请填写来源" value="<?php echo $info['url']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 排序 </label>
                  <div class="col-sm-9">
                    <input name="sort" type="text" class="col-xs-10 col-sm-5" placeholder="请填写来源" value="<?php echo $info['sort']; ?>" />
                  </div>
                </div>
...
<script type="text/javascript">
$('a[href="/Admin/Footers/index.html"]').parents().filter('li').addClass('open active');
//提交表单
