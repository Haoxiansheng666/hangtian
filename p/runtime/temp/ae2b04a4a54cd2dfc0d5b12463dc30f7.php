                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal form-post" role="form" method="post">
                            ...
                            <!--    <div class="col-sm-9">-->
                            <!--        <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写类型"-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="title" type="text" class="col-xs-10 col-sm-5" placeholder="请填写标题"
                            ...
                            <!--    <div class="col-sm-9">-->
                            <!--        <input name="url" type="text" class="col-xs-10 col-sm-5" placeholder="请填写链接地址"-->
...
<script type="text/javascript">
    $('a[href="/Admin/Overviews/index.html"]').parents().filter('li').addClass('open active');
    //提交表单
