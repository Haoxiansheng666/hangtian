                        ...
                        <form class="form-horizontal form-post" role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                                    <select name="is_show" class="state form-control" data-id="<?php echo $vo['id']; ?>">
                                      <option value="1" <?php if(1 == $info['is_show']): ?>selected<?php endif; ?> >启用</option>
                                      <option value="0" <?php if(0 == $info['is_show']): ?>selected<?php endif; ?> >禁用</option>
                                    </select>
                                </div>
                            </div>
