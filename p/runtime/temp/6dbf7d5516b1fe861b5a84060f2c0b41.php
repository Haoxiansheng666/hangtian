<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"D:\PHPTutorial\WWW\anji\public/../application/admin\view\overviews\adva.html";i:1587959069;s:62:"D:\PHPTutorial\WWW\anji\application\admin\view\common\top.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\header.html";i:1541637509;s:66:"D:\PHPTutorial\WWW\anji\application\admin\view\common\sidebar.html";i:1541637509;s:65:"D:\PHPTutorial\WWW\anji\application\admin\view\common\bottom.html";i:1541637509;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
                            ...
                            <div class="col-xs-12" style="margin-bottom:10px;">
                                <form action="<?php echo url('index'); ?>" method="get" class="form-inline" role="form">
                                    <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;"
                                       href="<?php echo url('adva_add'); ?>">添加信息</a>
                                </form>
                            </div>
                            <div class="col-xs-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success"
                                               href="<?php echo url('adva_edits',array('id'=>$vo['id'])); ?>">修改</a>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $('.state').change(function () {
            ...
            $.post("<?php echo url('adva_edits'); ?>", {id: id, status: state}).success(function (data) {
