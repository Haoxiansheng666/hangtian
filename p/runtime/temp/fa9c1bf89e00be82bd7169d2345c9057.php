<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"F:\phpStudy\PHPTutorial\WWW\pc\public/../application/admin\view\banners\index.html";i:1607412186;s:69:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\top.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\header.html";i:1541637510;s:73:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\sidebar.html";i:1541637510;s:72:"F:\phpStudy\PHPTutorial\WWW\pc\application\admin\view\common\bottom.html";i:1541637510;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo url('index'); ?>">首页设置</a></li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12" style="margin-bottom:10px;">
                                <form action="<?php echo url('add'); ?>" method="get" class="form-inline" role="form">
                                    <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;"
                                    href="<?php echo url('add'); ?>">添加轮播</a>
                                </form>
                            </div>
                            <div class="col-xs-12">
