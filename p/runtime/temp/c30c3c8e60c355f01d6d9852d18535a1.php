                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal form-post" role="form" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写岗位名称"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="sort" type="text" class="col-xs-10 col-sm-5" placeholder="请填写序号"
...
<script type="text/javascript">
    $('a[href="/Admin/Recruits/index.html"]').parents().filter('li').addClass('open active');
    //提交表单
