define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'supervise/index' + location.search,
                    add_url: 'supervise/add',
                    edit_url: 'supervise/edit',
                    // del_url: 'supervise/del',
                    multi_url: 'supervise/multi',
                    import_url: 'supervise/import',
                    table: 'company',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        // {field: 'house', title: __('House'), operate: 'LIKE'},
