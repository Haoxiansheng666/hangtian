<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\phpstudy_pro\WWW\boyou\public/../application/admin\view\supervise\add.html";i:1647940887;s:68:"D:\phpstudy_pro\WWW\boyou\application\admin\view\layout\default.html";i:1642752126;s:65:"D:\phpstudy_pro\WWW\boyou\application\admin\view\common\meta.html";i:1642752126;s:67:"D:\phpstudy_pro\WWW\boyou\application\admin\view\common\script.html";i:1642752126;}*/ ?>
<!DOCTYPE html>
...
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-cert_type" class="form-control" name="row[cert_type]" type="text">-->
<!--        </div>-->
<!--    </div>-->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('辖区'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('area[]', $address, null, ['class'=>'form-control selectpicker', 'multiple'=>'', 'data-rule'=>'required']); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-house" class="form-control" name="row[house]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-indent" class="form-control" name="row[ident]" type="text">
        </div>
    </div>
    <div class="form-group">
