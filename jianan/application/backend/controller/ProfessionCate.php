...
use app\backend\model\ProfessionCate as C;
use app\backend\logic\CustomerLogic;
class ProfessionCate  extends Common
{   
    protected $tableName = 'profession_cate';
    ...
    protected function write_log($data){
        $contents="添加 / 修改了工种分类，名称：".$data['name'];
