    ...
    const bioarea = {
        render: function({ elem, defaultData, form }) {
            ...
            form.on('select(' + elem + '1level)', function(e) {
                ...
                $("input[name='province_text']").val(e.elem[e.elem.selectedIndex].text);
                form.render('select')
            })
            form.on('select(' + elem + '2level)', function(e) {
                ...
                $("input[name='city_text']").val(e.elem[e.elem.selectedIndex].text);
                form.render('select')
            })
            form.on('select(' + elem + '3level)', function(e) {
                $("input[name='county_text']").val(e.elem[e.elem.selectedIndex].text);
            })
